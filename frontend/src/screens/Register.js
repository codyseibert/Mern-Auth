...
const Register = () => {
    ...
    const HandleFormSubmit = async (e) => {
        ...
        try {
            ...
            // MAKING API REQUEST
            const apiReq = await axios.post('/api/auth/user/register', data)
            console.log(apiReq);
        ...
        <div className="jumbotron">
            ...
            <Form onSubmit={HandleFormSubmit}>
                ...
                <Form.Group>
                    ...
                    <Form.Control type="password" placeholder="Confirm Password" onChange={(e) => setConfirmPass(e.target.value)} value={confirmPass}/>
                </Form.Group>

                <Button type="submit" variant="outline-info">Create Account</Button>
                 <br/> <br/>
